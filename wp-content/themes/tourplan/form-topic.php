                ...
                <fieldset class="bbp-form">
                    <legend class="text-medium">
                        ...
                        if ( bbp_is_topic_edit() )
                            ...
                            bbp_is_single_forum() ? printf( __( 'Create a new topic in &ldquo;%s&rdquo;', 'bbpress' ), bbp_get_forum_title() ) : _e( 'Create New Topic', 'bbpress' );
                        ?>
                    </legend>
                    ...
                    <div class="weight-normal">
                        ...
                        <p class="text-small">
                            ...
                            <input placeholder="Enter a title which best describes your topic" class="form-control" type="text" id="bbp_topic_title" value="<?php bbp_form_topic_title(); ?>" tabindex="<?php bbp_tab_index(); ?>" size="40" name="bbp_topic_title" maxlength="<?php bbp_title_max_length(); ?>" />
                        </p>
                        ...
                        <?php bbp_the_content_tp( array( 'context' => 'topic' ) ); ?>
                        ...
                        <?php if ( bbp_allow_topic_tags() && current_user_can( 'assign_topic_tags' ) ) : ?>
                            ...
                            <p class="text-small margin-top-10">
                                ...
                                <input placeholder="Separate tags by comma (,)." class="form-control" type="text" value="<?php bbp_form_topic_tags(); ?>" tabindex="<?php bbp_tab_index(); ?>" size="40" name="bbp_topic_tags" id="bbp_topic_tags" <?php disabled( bbp_is_topic_spam() ); ?> />
                            </p>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <p class="text-small">
                                        ...
                                        <?php bbp_form_topic_type_dropdown_tp(); ?>
                                    </p>
                                </div>
                                <div class="col-md-6">
                                    <p class="text-small">
                                        <label for="bbp_topic_status"><?php _e( 'Topic Status:', 'bbpress' ); ?></label><br />
                                        <?php bbp_form_topic_status_dropdown_tp(); ?>
                                    </p>
                                </div>
                        ...
                        <?php if ( bbp_is_subscriptions_active() && !bbp_is_anonymous() && ( !bbp_is_topic_edit() || ( bbp_is_topic_edit() && !bbp_is_topic_anonymous() ) ) ) : ?>
                            ...
                            <p class="text-small">
                                <input class="fix-chkbx-alignment" name="bbp_topic_subscription" id="bbp_topic_subscription" type="checkbox" value="bbp_subscribe" <?php bbp_form_topic_subscribed(); ?> tabindex="<?php bbp_tab_index(); ?>" />
                        ...
                        <div class="bbp-submit-wrapper">
                            ...
                            <button class="btn btn-primary text-small" type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_topic_submit" name="bbp_topic_submit" class="button submit"><?php _e( 'Submit', 'bbpress' ); ?></button>
